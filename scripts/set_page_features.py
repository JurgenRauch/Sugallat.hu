...
FEATURES_BY_PAGE: dict[str, list[str]] = {
    ...
    "pricing": ["text-galleries", "faq", "square-patterns", "sticky-cta"],
    "services": ["text-galleries", "faq", "square-patterns", "sticky-cta", "drag-scroll"],
    ...
    "about": ["square-patterns", "sticky-cta"],
